...
function AboutUs() {
  return (
    <>
      <section
        className="h-[70vh]
             bg-[url('https://images.unsplash.com/photo-1548924607-fd498b796071?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-center bg-cover relative text-white flex items-center justify-center"
      >
      ...
      <section className="bg-white">
        <div className="container px-6 py-10 md:px-20 px-10 mx-auto">
          ...
          <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
            ...
            <div className="hidden lg:flex lg:w-1/2 lg:justify-center">
              <img
                ...
                src="https://images.unsplash.com/photo-1643308012242-704341800ef3?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl">
              <img
                className="object-cover w-full rounded-xl aspect-square"
                src="/public/my-notion-face-portrait (2).png"
                alt=""
              />
              <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize">
                Pamela Anderson
            ...
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl">
              <img
                className="object-cover w-full rounded-xl aspect-square"
                src="/public/my-notion-face-portrait (1).png"
                alt=""
              />
              <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize">
                John Doe
